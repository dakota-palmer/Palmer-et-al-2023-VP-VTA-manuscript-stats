...
pathData= paste(pathInput,'/fig5.pkl', sep="")
...
fig5_stats_Phase_1_FreeChoice_C_licks_mdThal_0_description= "Figure 5: Lever Choice, Phase 1- Free Choice, licks/reward, mdThal"
